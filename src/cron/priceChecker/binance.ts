// TODO: Чекер будет вытягивать алерты из базы по определенному признаку (source или тип того)
// TODO: Соответственно у других чекеров этот источник должен быть в исключениях
