...
echo "TELEGRAM_SIGNALS_API_ID=${TELEGRAM_SIGNALS_API_ID}" >> .env
echo "TELEGRAM_SIGNALS_API_HASH=${TELEGRAM_SIGNALS_API_HASH}" >> .env
echo "TELEGRAM_SIGNALS_SESSION_STRING=${TELEGRAM_SIGNALS_SESSION_STRING}" >> .env
echo "TELEGRAM_SIGNALS_BOT_TOKEN=${TELEGRAM_SIGNALS_BOT_TOKEN}" >> .env
